...
INSERT INTO analytics.analytics_data_source (id,type,version,created_on, updated_on, url_base, clazz_name) VALUES (1,'GROUP', '0', '2017-11-01 00:00:00','2017-11-01 00:00:00','http://localhost:8080/groups/api','com.libra.apollo.entity.Group');
INSERT INTO analytics.analytics_data_source (id,type,version,created_on, updated_on, url_base, clazz_name) VALUES (2,'PORTFOLIO', '0', '2017-11-01 00:00:00','2017-11-01 00:00:00','http://localhost:8080/portfolios/api','com.libra.apollo.entity.Portfolio');



-- Parameters
-- DECIMAL_PARAMETER
INSERT INTO analytics.analytics_parameter( id, type, version, created_on, updated_on, composition_type, data_field_type, operand) VALUES (1,'DATE_PARAMETER', '0', '2017-11-01 00:00:00','2017-11-01 00:00:00','AND','STAMP_DATE', 'EQUAL');
INSERT INTO analytics.analytics_parameter( id, type, version, created_on, updated_on, composition_type, data_field_type, operand, decimal_value ) VALUES (2,'DECIMAL_PARAMETER', '0', '2017-11-01 00:00:00','2017-11-01 00:00:00','AND','STAR_RATING', 'GREATER_THAN_OR_EQUAL','3.0');
INSERT INTO analytics.analytics_parameter( id, type, version, created_on, updated_on, composition_type, data_field_type, operand, decimal_value ) VALUES (3,'DECIMAL_PARAMETER', '0', '2017-11-01 00:00:00','2017-11-01 00:00:00','AND','STAR_RATING', 'LESS_THAN_OR_EQUAL','2.0');


-- Populating ID_PARAMETER

-- Populating apollo_analytics 
INSERT INTO analytics.analytics(id,version,created_on,updated_on, name,description,run_type,analytics_type) VALUES (1,'0', '2017-11-01 00:00:00','2017-11-01 00:00:00','Apollo Analyzer','Collection of defined Investment Styles', 'ON_DEMAND','APOLLO_ANALYZER');
...
INSERT INTO analytics.analytics_investment_style( id, name, description, priority, analytics_id, view_id,version,created_on,updated_on) VALUES (5,'Apollo Growth', 'These are stocks that are being re-rated by the market and the discount rate needing to be applied is low (or falling)', 1, 1, 1, '0', '2017-11-01 00:00:00','2017-11-01 00:00:00');
INSERT INTO analytics.analytics_investment_style( id, name, description, priority, analytics_id, view_id,version,created_on,updated_on) VALUES (6,'Apollo Value', 'These are stocks that are being de-rated by the market and the discount rate needing to be applied is high (or rising)', 1, 1, 1, '0', '2017-11-01 00:00:00','2017-11-01 00:00:00');
INSERT INTO analytics.analytics_investment_style( id, name, description, priority, analytics_id, view_id,version,created_on,updated_on) VALUES (7,'Below 12m Pessimistic', 'These are stocks trading at a discount to Apollo''s most pessimistic 12-month scenario.', 1, 1, 1, '0', '2017-11-01 00:00:00','2017-11-01 00:00:00');
INSERT INTO analytics.analytics_investment_style( id, name, description, priority, analytics_id, view_id,version,created_on,updated_on) VALUES (8,'Above 12m Optimistic', 'These are stocks trading at a premium to Apollo''s most optimistic 12-month scenario.', 1, 1, 1, '0', '2017-11-01 00:00:00','2017-11-01 00:00:00');
