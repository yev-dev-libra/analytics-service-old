...
public class InvestmentStyle extends AutoGeneratedId implements Comparable<InvestmentStyle> {
	...
	@SortNatural
	private SortedSet<InvestmentStyleProperty> investmentStyleProperties = new TreeSet<>();
	...
	public SortedSet<InvestmentStyleProperty> getInvestmentStyleProperties() {
		return investmentStyleProperties;
	}

	public void setInvestmentStyleProperties(SortedSet<InvestmentStyleProperty> investmentStyleProperties) {
