...
@NamedEntityGraphs({
	@NamedEntityGraph(name = InvestmentStyle.SHALLOW_GRAPH_NAME,
			attributeNodes = {
					...
					@NamedAttributeNode("investmentStyleFieldParameters")
					}
	),
	...
	@NamedEntityGraph(name = InvestmentStyle.DEEP_GRAPH_NAME,
			attributeNodes = {
					@NamedAttributeNode("view"),
					@NamedAttributeNode("analytics"),
					@NamedAttributeNode(value="investmentStyleParameters", subgraph = "queryParameterField"),
					@NamedAttributeNode(value="investmentStyleFieldParameters", subgraph = "parameterField"),
					},
			subgraphs =  {
					@NamedSubgraph(name = "queryParameterField",
							attributeNodes = {
									@NamedAttributeNode("queryParameter")}
					),
					@NamedSubgraph(name = "parameterField",
					attributeNodes = {
							@NamedAttributeNode("fieldParameter")}
							)
					}
...
@Table(name = "analytics_investment_style"
)
...
public class InvestmentStyle extends AutoGeneratedId implements Comparable<InvestmentStyle> {
	...
	@OneToMany(mappedBy = "investmentStyle", cascade = CascadeType.ALL, orphanRemoval = true, fetch = FetchType.LAZY)
	@SortNatural
	private SortedSet<InvestmentStyleFieldParameter> investmentStyleFieldParameters = new TreeSet<>();
	...
	public SortedSet<InvestmentStyleFieldParameter> getInvestmentStyleFieldParameters() {
		return investmentStyleFieldParameters;
	}

	public void setInvestmentStyleFieldParameters(SortedSet<InvestmentStyleFieldParameter> investmentStyleFieldParameters) {
