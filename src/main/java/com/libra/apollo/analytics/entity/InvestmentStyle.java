...
public class InvestmentStyle extends AutoGeneratedId implements Comparable<InvestmentStyle> {
	...
	public SortedSet<InvestmentStyleCondition> getInvestmentStyleConditions() {
		return investmentStyleConditions;
	}

	public void setInvestmentStyleConditions(SortedSet<InvestmentStyleCondition> investmentStyleConditions) {
