...
public class AnalyticsContextFactory {
	...
	public static AnalyticsContext getContext(final AnalyticsService analyticsService,
			...
			final AsyncTaskExecutor executorService, final Map<String, String> properties,
		...
		case SCREEN_FOR_PORTFOLIOS: {
			context = new PortfolioScreenerContext(analyticsService, configurationService, portfolioService, executorService, Operation.SCREEN_FOR_PORTFOLIOS, properties, request);
